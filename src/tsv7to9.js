...
// если occurrence равен 0 то просто пропускаем, можно скопировать из quote контент
 ...
 * Кроме этого надо добавить occurrence чтобы знать который раз встречается это слово в тексте
